      ...
      while ( have_posts() ) :
         ...
         $prev_post = get_previous_post();
			the_post_navigation(
				...
				array(
					'prev_text' => '<span class="nav-subtitle class="icon_facebook_white_small">' . esc_html__( 'Previous:', 'test' ) .get_the_post_thumbnail($prev_post->ID,'thumbnail'). '</span> <span class="nav-title">%title</span>',
