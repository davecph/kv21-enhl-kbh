         ...
         $prev_post = get_previous_post();
			the_post_navigation(
				...
				array(
					...
					'next_text' => '<span class="nav-subtitle"><span class="nav-title">%title</span>'.get_the_post_thumbnail($next_post->ID,'thumbnail').'<span class="icon_arrow-r_white_medium"></span></span>',
				)
			);
         echo "<!-- 04 -->";
